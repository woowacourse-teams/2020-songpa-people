...
public class RectDividerTest {
    ...
    @Test
    void divideRectTest() {
        Rect rect = Rect.byOffset(new Latitude(33), new Longitude(126.5), 0.1);
    ...
    @Test
    void name() {
        Rect rect = Rect.byOffset(new Latitude(33), new Longitude(126), 0.04);
        List<Rect> dividedRects = RectDivider.divide(rect, BigDecimal.valueOf(0.02));

        assertThat(dividedRects).hasSize(4);
        assertThat(dividedRects).contains(Rect.byOffset(new Latitude(33), new Longitude(126), 0.02));
        assertThat(dividedRects).contains(Rect.byOffset(new Latitude(33 + 0.02), new Longitude(126), 0.02));
        assertThat(dividedRects).contains(Rect.byOffset(new Latitude(33), new Longitude(126 - 0.02), 0.02));
        assertThat(dividedRects).contains(Rect.byOffset(new Latitude(33 + 0.02), new Longitude(126 - 0.02), 0.02));
    }
}
